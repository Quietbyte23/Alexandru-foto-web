...
const PORTFOLIO_PHOTOS: Photo[] = [
  { 
    id: '1', 
    src: '/portret-cu-vedere-spre-oras.webp', 
  ...
  { 
    ...
    titleRo: 'Liniște & Peisaj', 
    titleEn: 'Serene Views', 
    category: 'NATURE', 
    location: 'Outdoor' 
  },
  { 
    id: '6', 
    src: '/portret-oras.webp', 
    titleRo: 'Perspective Urbane', 
    titleEn: 'Urban Perspectives', 
    category: 'PORTRAIT', 
    location: 'City' 
  },
];

  // Repetăm pentru restul pozelor tale
